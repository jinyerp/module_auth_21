@extends('jiny-auth::layouts.resource.edit')
@section('title', '약관 수정')
@section('description', '약관 정보를 수정하세요.')

{{-- 페이지 상태 스크립트 --}}
@section('page-script', 'Edit')
@section('heading')
    <section class="w-full">
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            <article class="flex-1 min-w-0">
                <h1 class="text-2xl font-semibold text-gray-900">약관 수정</h1>
                <p class="mt-2 text-base text-gray-700 leading-relaxed">약관 정보를 수정합니다. 약관명, 타입, 내용, 버전 등의 정보를 변경할 수 있습니다.</p>
            </article>
        ...
        <form action="{{ route($route.'update', $item->id) }}" method="POST" class="mt-6" id="edit-form" data-list-url="{{ route($route.'index') }}">
                ...
                <x-ui::form-section
                    ...
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 relative">
                                <select name="type" id="type"
                                    ...
                                    <option value="optional" {{ old('type', $item->type) == 'optional' ? 'selected' : '' }}>선택</option>
                                    <option value="required" {{ old('type', $item->type) == 'required' ? 'selected' : '' }}>필수</option>
                                </select>
                                @if($errors->has('type'))
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 relative">
                                <input type="text" name="version" id="version" value="{{ old('version', $item->version) }}"
                ...
                <x-ui::form-section
                    ...
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-2 relative">
                                <textarea name="content" id="content" rows="8"
                                    ...
                                    data-quill-editor>{{ old('content', $item->content) }}</textarea>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-2 relative">
                                <input type="text" name="description" id="description" value="{{ old('description', $item->description) }}"
                ...
                <x-ui::form-section
                    ...
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 relative">
                                <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $item->display_order) }}"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 relative">
                                <select name="is_active" id="is_active"
                                    ...
                                    <option value="1" {{ old('is_active', $item->is_active) == '1' ? 'selected' : '' }}>활성</option>
                                    <option value="0" {{ old('is_active', $item->is_active) == '0' ? 'selected' : '' }}>비활성</option>
                                </select>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 relative">
                                <input type="date" name="effective_date" id="effective_date" value="{{ old('effective_date', $item->effective_date ? $item->effective_date->format('Y-m-d') : '') }}"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 relative">
                                <input type="date" name="expiry_date" id="expiry_date" value="{{ old('expiry_date', $item->expiry_date ? $item->expiry_date->format('Y-m-d') : '') }}"
            ...
            <div class="mt-6 flex items-center justify-between">
                ...
                <div class="flex items-center gap-x-6">
                    ...
                    <x-ui::button-primary type="button" id="submitBtn">
